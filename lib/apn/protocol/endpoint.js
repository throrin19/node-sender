...
module.exports = function (dependencies) {
    ...
    function Endpoint(options) {
        ...
        this._log = options.log.child({ component : 'apn-Endpoint' });
    ...
    Endpoint.prototype._setupHTTP2Pipeline = function _setupHTTP2Pipeline() {
        const serializer = new protocol.Serializer(this._log);
        const compressor = new protocol.Compressor(this._log, "REQUEST");
        const deserializer = new protocol.Deserializer(this._log);
        const decompressor = new protocol.Decompressor(this._log, "RESPONSE");
    ...
    Endpoint.prototype._connect = function connect() {
        ...
        this._connection = new protocol.Connection(this._log, 1);
